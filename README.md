...
The rainfall section also provides a separate policy-action view. Confirmed high flood hazard requires both High rainfall exposure and Sentinel-1 flood evidence at or above the live 67th percentile among schools with observed flood signal. Disagreement between the rainfall and Sentinel-1 signals is assigned to field verification. Confirmed hazard with weak/partial PMIU capacity is immediate protection; confirmed hazard with adequate capacity is resilience investment. Enrolment is displayed for scale, not used to assign the action category.
